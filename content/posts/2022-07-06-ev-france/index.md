...
![](/_images/ev-france-2022/costs.png)
...
[^2]:
     When I say "highway range" I mean highway range. Aircon on, set to auto/comfort, no eco modes or anything. Drive mode set to "comfort." Cruise control set to the speed limit or 140 km/h in unrestricted sections of the German autobahn. And yes, on said sections I will exceed 140 km/h if I need to overtake. 
...
[^4]:
     In Germany it's a bit less, in France a bit more, in Luxembourg a lot less, in the Netherlands a lot more. 
