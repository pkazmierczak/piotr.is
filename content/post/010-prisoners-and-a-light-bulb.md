...
[Hans van Ditmarsch's](http://personal.us.es/hvd/)
[DEL](http://plato.stanford.edu/entries/logic-epistemic/#3) course, and at the
end of it he presented a "100 prisoners and a light bulb" puzzle, asking us
for the solution.

Unexpectedly, I've found the solution, but didn't dare saying it aloud, since
I was convinced it was wrong. Once prof. van Ditmarsch told everyone what it
was, I was still convinced it can't be true, and even Karolina (who understood
everything very well) wasn't able to convince me that it actually works.
That's a perfect example how [positive introspection](http://en.wikipedia.org/
wiki/Epistemic_modal_logic#The_positive_introspection_axiom) doesn't apply to
some agents (i.e. me).

Here's the puzzle (taken directly from Hans van Ditmarsch's slides), go on and
...
> be executed. While still in the dining room, and before the prisoners go to
> their isolation cells (forever), can the prisoners agree on a protocol that
> will set them free?
